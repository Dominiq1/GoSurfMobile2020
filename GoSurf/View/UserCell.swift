        ...
        if let id = message?.chatPartnerId() {
            ...
            ref.observeSingleEvent(of: .value, with: { (snapshot) in
                ...
                if let dictionary = snapshot.value as? [String: AnyObject] {
                    self.nameLable.text = dictionary["name"] as? String
...
//        label.text = "Date"
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        nameLable.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 82).isActive = true
        nameLable.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: -8).isActive = true
        ...
        detailLable.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 82).isActive = true
//        detailLable.centerYAnchor.constraint(equalTo: self.centerYAnchor).isActive = true
