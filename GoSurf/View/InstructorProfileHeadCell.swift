//
//  InstructorProfileHeadCell.swift
//  GoSurf
//
...
class InstructorProfileHeadCell: UITableViewCell {
...
//
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        detailLable.topAnchor.constraint(equalTo: nameLable.bottomAnchor, constant: 6).isActive = true
