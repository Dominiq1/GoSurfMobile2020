...
@available(iOS 13.4, *)
@available(iOS 13.4, *)
class PhotographerProfileViewController: UITableViewController, UINavigationControllerDelegate {
    ...
    var user: User? {
        ...
        didSet {
            ...
            if checker == 0 {
                ...
                if self.user?.businessType == "Photographer" {
                    //change the title to admin's name
                    self.title = "Photographer Profile"
                    
                } else {
                    
                    self.title = "Videographer Profile"
                }
                ...
                self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Edit ✎", style: .plain, target: self, action: #selector(openEditPhotographerProfileViewController))
...
//        self.navigationItem.rightBarButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "chat"), style: .plain, target: self, action: #selector(openChatViewController))
    ...
    @objc func openEditPhotographerProfileViewController() {
        
        let viewController = EditPhotographerProfileViewController()
...
//            cell.locationLable.text = self.user?.address
    ...
    //backend stuff
         let viewController = BookPhotographerViewController()
