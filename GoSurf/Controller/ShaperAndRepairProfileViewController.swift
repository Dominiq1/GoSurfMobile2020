//
//  ShaperAndRepairProfileViewController.swift
//  GoSurf
//
...
@available(iOS 13.4, *)
class ShaperAndRepairProfileViewController: UITableViewController, UINavigationControllerDelegate {
    ...
    var user: User? {
        ...
        didSet {
            ...
            if self.user?.businessType == "Shaper" {
                
                self.title = "Shaper Profile"
                
            } else if self.user?.businessType == "Glassing"  {
                
                self.title = "Glassing Profile"
                
            } else {
                
                self.title = "Repair Profile"
