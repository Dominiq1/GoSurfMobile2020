...
class ChatLogController: UICollectionViewController, UITextFieldDelegate, UICollectionViewDelegateFlowLayout {
    ...
    private func initNavigationItemTitleView() {
        ...
        let recognizer = UITapGestureRecognizer(target: self, action: #selector(openProfileViewController))
    ...
    @objc func openProfileViewController() {
        ...
        switch String((user?.businessType)!) {
...
//        setupKeyboardObservers()
    ...
    lazy var inputContainerView: UIView = {
        ...
        sendButton.setImage(#imageLiteral(resourceName: "send25"), for: .normal)
    ...
    func setupInputComponents() {
        ...
        containerViewBottomAnchor = containerView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -50)
    ...
    @objc func handleSend() {
        ...
        print("--------time stamp below----------")
        //seconds since 1970 date
        print(timestamp)
        print("--------------------")

        
        
        //-----add if statement to check if inputTextfield has a phone number, email, or website.
        ...
        string.utf16.count))
            ...
            for result in results {
                if let range = Range(result.range, in: string) {
                    ...
                    case .phoneNumber :
                        let alert = UIAlertController(title: "Phone Number Detected", message: "Sorry, for your safety and others on the GoSurf platform, we have removed the ability to exchange phone numbers. - The GoSurf Team", preferredStyle: .alert)
                    ...
                    case .address:
                          let alert = UIAlertController(title: "Address Detected", message: "Sorry, for your safety and the safety of others on GoSurf Mobile, we have removed the ability to exchange locations. However, you can find your nearest Go Surf Station here: INSERT NEAREST GOSURFSTATION HERE -The GoSurf Team", preferredStyle: .alert)
                    ...
                    default:
                                   //-----------copied values for switch case below------------------
                                        let values = [
    ...
    func showInstructorProfileViewController(_ name: String, _ email: String ) {
        ...
        instructorViewController.checker = 3
