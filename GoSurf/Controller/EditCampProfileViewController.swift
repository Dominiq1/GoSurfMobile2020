//
//  EditCampProfileViewController.swift
//  GoSurf
//
//  Created by Piyush on 23/06/20.
...
@available(iOS 13.4, *)
class EditCampProfileViewController: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var viewController = CampProfileViewController()
    ...
    func setupViews()  {
        ...
        addressTextField.topAnchor.constraint(equalTo: editAvailabilityButton.bottomAnchor, constant: 16).isActive = true
...
@available(iOS 13.4, *)
extension EditCampProfileViewController: AddAddressDelegate {
