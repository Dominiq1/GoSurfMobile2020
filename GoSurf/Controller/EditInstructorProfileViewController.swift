//
//  EditInstructorProfileViewController.swift
//  GoSurf
//
...
@available(iOS 13.4, *)
@available(iOS 13.4, *)
class EditInstructorProfileViewController: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    lazy var cVS = CGSize(width: self.view.frame.width, height: 750)
                        ...
                        { (snapshot) in
                            newImageRef.downloadURL { (url, error) in
                                ...
                                let values = ["name": self.nameTextField.text!,
                                              ...
                                              "surfboards": self.surfboardQuantityTextField.text!,
                                              "wetsuits": self.wetsuitQuantityTextField.text!,
    ...
    @objc func handleEditLessonType(){
        ...
        let viewController = EditLessonTypeViewController()
    ...
    let editServicePackageButton: UIButton = {
        let button = UIButton(type: .system)
        button.backgroundColor = UIColor(r: 22, g: 128, b: 199)
        button.setTitle("Edit Service Package", for: UIControl.State())
    ...
    let surfboardQuantityTextField: UITextField = {
        let tf = UITextField()
        tf.placeholder = "No. of available Surfboards"
    ...
    let surfboardSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 220, g: 220, b: 220)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    ...
    let wetsuitQuantityTextField: UITextField = {
        let tf = UITextField()
        tf.placeholder = "No. of available Wetsuits"
        tf.textAlignment = .right
        tf.keyboardType = .numberPad
        tf.textColor = UIColor(r: 22, g: 128, b: 199)
        tf.translatesAutoresizingMaskIntoConstraints = false
    ...
    let wetsuitSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 220, g: 220, b: 220)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    ...
    func setupViews()  {
        ...
        containerView.addSubview(gearTitleLable)
        
        containerView.addSubview(wetsuitImageView)
        containerView.addSubview(wetsuitQuantityTextField)
        containerView.addSubview(wetsuitSeparatorView)
        
        containerView.addSubview(surfboardImageView)
        containerView.addSubview(surfboardSeparatorView)
        containerView.addSubview(surfboardQuantityTextField)
        ...
        descriptionTextView.topAnchor.constraint(equalTo: descriptionLable.bottomAnchor, constant: 8).isActive = true
        descriptionTextView.heightAnchor.constraint(equalToConstant: 120).isActive = true
        
        gearTitleLable.leftAnchor.constraint(equalTo: containerView.leftAnchor, constant: 20).isActive = true
        gearTitleLable.topAnchor.constraint(equalTo: descriptionTextView.bottomAnchor, constant: 16).isActive = true
        gearTitleLable.heightAnchor.constraint(equalToConstant: 20).isActive = true
        
        wetsuitImageView.topAnchor.constraint(equalTo: gearTitleLable.bottomAnchor, constant: 8).isActive = true
        ...
        wetsuitImageView.leftAnchor.constraint(equalTo: containerView.leftAnchor, constant: 20).isActive = true
        
        wetsuitQuantityTextField.bottomAnchor.constraint(equalTo: wetsuitImageView.bottomAnchor).isActive = true
        wetsuitQuantityTextField.leftAnchor.constraint(equalTo: wetsuitImageView.rightAnchor, constant: 20).isActive = true
        wetsuitQuantityTextField.rightAnchor.constraint(equalTo: containerView.rightAnchor, constant: -20).isActive = true
        
        wetsuitSeparatorView.topAnchor.constraint(equalTo: wetsuitQuantityTextField.bottomAnchor, constant: 0).isActive = true
        wetsuitSeparatorView.leftAnchor.constraint(equalTo: wetsuitQuantityTextField.leftAnchor).isActive = true
        wetsuitSeparatorView.rightAnchor.constraint(equalTo: wetsuitQuantityTextField.rightAnchor).isActive = true
        wetsuitSeparatorView.heightAnchor.constraint(equalToConstant: 1).isActive = true
        
        surfboardImageView.topAnchor.constraint(equalTo: wetsuitImageView.bottomAnchor, constant: 8).isActive = true
        surfboardImageView.widthAnchor.constraint(equalTo: wetsuitImageView.widthAnchor ).isActive = true
        surfboardImageView.heightAnchor.constraint(equalTo: wetsuitImageView.heightAnchor ).isActive = true
        surfboardImageView.leftAnchor.constraint(equalTo: containerView.leftAnchor, constant: 20).isActive = true
        
        surfboardQuantityTextField.bottomAnchor.constraint(equalTo: surfboardImageView.bottomAnchor).isActive = true
        surfboardQuantityTextField.leftAnchor.constraint(equalTo: surfboardImageView.rightAnchor, constant: 20).isActive = true
        surfboardQuantityTextField.rightAnchor.constraint(equalTo: containerView.rightAnchor, constant: -20).isActive = true
        
        surfboardSeparatorView.topAnchor.constraint(equalTo: surfboardQuantityTextField.bottomAnchor, constant: 0).isActive = true
        surfboardSeparatorView.leftAnchor.constraint(equalTo: surfboardQuantityTextField.leftAnchor).isActive = true
        surfboardSeparatorView.rightAnchor.constraint(equalTo: surfboardQuantityTextField.rightAnchor).isActive = true
        surfboardSeparatorView.heightAnchor.constraint(equalToConstant: 1).isActive = true
        
        mediaTitleLable.leftAnchor.constraint(equalTo: containerView.leftAnchor, constant: 20).isActive = true
        mediaTitleLable.topAnchor.constraint(equalTo: surfboardSeparatorView.bottomAnchor, constant: 16).isActive = true
...
//                imageViewThree.leftAnchor.constraint(equalTo: imageViewTwo.rightAnchor, constant: -2).isActive = true
    ...
    func addDoneButtonOnKeyboard(){
        ...
        wetsuitQuantityTextField.inputAccessoryView = doneToolbar
        
        surfboardQuantityTextField.inputAccessoryView = doneToolbar
    }
    ...
    func setupData(_ user: User) {
        ...
        self.surfboardQuantityTextField.text = user.surfboards
        
        self.wetsuitQuantityTextField.text = user.wetsuits
...
@available(iOS 13.4, *)
extension EditInstructorProfileViewController: AddAddressDelegate {
